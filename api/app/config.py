...
class Settings(BaseSettings):
    ...
    seed_examples_per_label: int = 30
    max_examples_per_request: int = 500
    eval_holdout_ratio: float = 0.2
    quick_start_rate_limit: int = 3
    quick_start_rate_window_seconds: int = 3600
    run_rate_limit: int = 6
    run_rate_window_seconds: int = 3600
    run_stream_max_seconds: int = 1800
    run_stream_poll_interval: float = 1.0
    orphaned_run_timeout_seconds: int = 3600
